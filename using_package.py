...
print(info_segitiga())
print(f"hitung_luas_segitiga {hitung_luas_segitiga(70,26)}")

print(info_kotak())
print(f'hitung_keliling_kotak {hitung_keliling_kotak(5, 5, 5, 5)}')

print(info_balok())
print(f'hitung_luas_balok {hitung_luas_balok(8, 5, 12)}')
